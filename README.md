...
NanoPi R5S) — и для десктопа: тот же control-plane работает на одной машине как клиент
(`lotsman-client`, плюс отдельные GUI-окно и трей; см. [`docs/CLIENT.md`](docs/CLIENT.md)). Следит за сервисами, прозванивает их по реальному пути LAN-клиента и
